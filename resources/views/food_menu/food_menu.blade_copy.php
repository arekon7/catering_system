...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="css/food_menu/style.css" />
		<link href='http://fonts.googleapis.com/css?family=Raleway:300,500|Arvo:700' rel='stylesheet' type='text/css'>
		<script type="text/javascript" src="js/food_menu/modernizr.custom.79639.js"></script> 
    ...
    <body>
        ...
        <script type="text/javascript" src="js/food_menu/menu.js"></script>
